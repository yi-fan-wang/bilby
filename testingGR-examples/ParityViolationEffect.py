...
injection_parameters = dict(
    ...
    dchi_2=0.0,dchi_3=0.0,mg_lambda=0.0,dalpha_2=0.0,parity_lambdatilt=0.0, parity_alpha=0)
...
priors['dchi_3'] = 0.0
priors['dalpha_2'] = 0.0
priors['parity_lambdatilt'] = bilby.core.prior.Uniform(
    minimum= 1e5,
    maximum=  1e15,
    name='parity_lambdatilt', latex_label=r'$\tilt\Lambda$')
